...
class color_pid:
	def __init__(self):
		...
		self.linear_Kp = rospy.get_param('linear_Kp',2e-2)
		self.linear_Kd = rospy.get_param('linear_Kd',4e-3)
		self.angular_Kp = rospy.get_param('angular_Kp',6e-3)
		self.angular_Kd = rospy.get_param('angular_Kd',1e-3)
